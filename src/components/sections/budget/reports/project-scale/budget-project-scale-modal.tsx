...
export default function BudgetProjectScaleModal({formData, initialData}: BeforeproposalBudgetTableReadProps){
    // const [data, setData] = useState<GetSingleBeforeProposalItemShape[]>([]);
