...
function ProposalBudgetFormPisnahadi(props: ProposalBudgetFormProps) {
  ...
  const submitMutation = useMutation(proposalBudgetApi.getDataPish, {
    onSuccess: (data) => {
...
export default ProposalBudgetFormPisnahadi;
