...
export const loadreport = (data: GetSingleProposalItemShape[]) => {
  ...
  // const StimulFileJsonString = '{"test":"1"}';
  ...
  // const _tmp = JSON.parse(StimulFileJsonString);
  // report.loadFromJsonInternal(_tmp);
  // report.loadFile("/proposal.mrt");
  ...
  // options.appearance.fullscreen = true;
  ...
  //  viewerContent = <div id="viewerContent"></div>
};
