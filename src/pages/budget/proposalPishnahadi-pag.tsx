...
import TransferFormPish from './../../components/sections/report/transfer/proPishForm';
...
function BudgetProposalPagePishnahadi() {
  ...
  // table heads
   const tableHeadGroups: TableHeadGroupShape = [
    {
      title: <TransferFormPish formData={formData} setFormData={setFormData} />,
      colspan: 7,
    },
  ];
     ...
     <SectionGuard
        ...
        >
          <IconButton
            color="success"
            size="small"
            onClick={() => insertCodeAccMutation.mutate({
            ...formData,
...
export default BudgetProposalPagePishnahadi;
